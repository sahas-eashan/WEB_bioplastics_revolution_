            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-20 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto mb-12 leading-relaxed">
                        Transforming seaweed into sustainable bioplastics to fight ocean pollution 
                        and empower coastal communities worldwide
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                            ...
                            <h3 className="text-2xl font-bold text-gray-800 mb-2">Ocean Cleanup</h3>
                            <p className="text-gray-600">Reducing plastic pollution in our oceans through sustainable alternatives</p>
                        </div>
                        ...
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                            ...
                            <h3 className="text-2xl font-bold text-gray-800 mb-2">Eco Solutions</h3>
                            <p className="text-gray-600">Creating biodegradable materials from renewable seaweed resources</p>
                        </div>
                        ...
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                            ...
                            <p className="text-gray-600">Empowering coastal communities through sustainable innovation</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-700 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center relative">
                    ...
                    <p className="text-xl max-w-3xl mx-auto leading-relaxed">
                        We believe in the power of innovation to heal our planet. By transforming ocean seaweed 
                        into biodegradable bioplastics, we're creating a sustainable future where environmental 
